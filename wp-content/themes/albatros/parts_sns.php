...
<!--LINEボタン-->   
<li class="line">
<a href="//line.me/R/msg/text/?<?php echo $title_encode . '%0A' . $url_encode;?>"><span class="text">LINE</span></a>
</li>     
...
<!--feedlyボタン-->
<li class="feedly">
<a href="//feedly.com/index.html#subscription%2Ffeed%2Fhttp%3A%2F%2F<?php echo $plainurl ;?>%2Ffeed%2F"  target="blank"><i class="fa fa-rss"></i><span class="text">feedly</span><span class="count"><?php if(function_exists('scc_get_follow_feedly')) echo (scc_get_follow_feedly()==0)?'':scc_get_follow_feedly(); ?></span></a></li>    
</ul>
</div>
</div>